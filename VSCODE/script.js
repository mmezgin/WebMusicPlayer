$(document).ready(function(){
  ...
  $('#s1').click(function() {
    var text = $('#songName1').text();
    var color = "color:rgb(255,255,255);";
    var size = "font-size:24px;"
    var style = "font-style:oblique;"
    var inner = "<h3 style="+color+""+size+""+style+">"+text+"</h3>"
    $('#textRock').html(inner);
...
$('#s7').click(function() {
 ...
 $('#s8').click(function() {
  var text = $('#songName8').text();
  var color = "color:rgb(255,255,255);";
    var size = "font-size:24px;"
    var style = "font-style:oblique;"
    var inner = "<h3 style="+color+""+size+""+style+">"+text+"</h3>"
    $('#textRock').html(inner);
    $("#img").attr("src","rockImg/sandman.png");
  
});
$('#s9').click(function() {
  var text = $('#songName9').text();
  var color = "color:rgb(255,255,255);";
    var size = "font-size:24px;"
    var style = "font-style:oblique;"
    var inner = "<h3 style="+color+""+size+""+style+">"+text+"</h3>"
