...
if(this.readyState == 4 && this.status == 200){
  ...
  for(var a=0; a < data.length; a++){
    songName2[a] = data[a].song;
    
  }

  var arr2 = songName2.join('\r\n');
...
var targetOffset = $('#hotslide').offset().top;
